...
const TransactionHistory = () => {
  ...
  return (
    <div
      // style={backImg}
      className="h-[88.6vh] relative bg-teal-300 w-full  bg-center bg-no-repeat bg-cover mt-12 md:mt-[4.5rem] before:content-[''] before:bg-gradient-to-br before:from-teal-700 before:absolute before:block before:h-full before:w-full"
    >
      {/* List of Customers */}

      <div className="relative overflow-x-auto shadow-md sm:rounded-lg max-w-[80%] mx-auto top-16 ">
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-green-500">
            <tr>
