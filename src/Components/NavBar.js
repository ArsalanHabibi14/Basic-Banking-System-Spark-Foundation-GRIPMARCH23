...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white z-50  px-2 sm:px-4 py-2.5 dark:bg-teal-700 fixed w-full  top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        >
          <img
            src="./spark.png"
            className="h-7 mr-3 sm:h-9 bg-white/20"
            alt="spark Logo"
          />
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
          <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-green-500 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-green-900 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link
                to="/"
        ...
        >
          <ul className="h-full w-full text-center pt-12 ">
            ...
            <li className="text-2xl py-5  mt-3 hover:bg-white/20 ease-in duration-100  rounded-tl-2xl rounded-br-2xl">
              <Link to="/allcustomers" className="block">
                Cutomers
              </Link>
            </li>
            <li className="text-2xl py-5  mt-3 hover:bg-white/20 ease-in duration-100  rounded-tl-2xl rounded-br-2xl">
