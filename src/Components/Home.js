...
const Home = () => {
  ...
  return (
    <div
      // style={backImg}
      className="h-[88.6vh] relative  bg-center bg-teal-500 bg-no-repeat bg-cover mt-12 md:mt-[4.5rem] before:content-[''] before:bg-gradient-to-br before:from-gray-900/100 before:absolute before:block before:h-full before:w-full"
    >
        ...
        >
          <Typewriter
            ...
            onInit={(typewriter) => {
              typewriter
                .typeString(
                  "welcome to the sparks bank! experiance the fastest transaction service with us!"
                )
                .pauseFor(1000)
                .start();
            }}
